...
// 本体
const ModalEvolution= ({ evolutions }:ModalEvolutionProps): React.ReactNode => {
 
  // 進化系統の描画処理
  const evolutionDisplay = (evolutions: EvoObj[]): React.ReactNode => {
