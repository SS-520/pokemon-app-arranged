...
// タイプ画像の共通部分
const commonTypeImgURL: string = 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/types/generation-ix/scarlet-violet/';
...
export const types: TypeDetails[] = [
  {
    number: 1,
    name: `ノーマル`,
    imgURL: `${commonTypeImgURL}1.png`,
  },
  {
    number: 2,
    name: `かくとう`,
    imgURL: `${commonTypeImgURL}2.png`,
  },
  {
    number: 3,
    name: `ひこう`,
    imgURL: `${commonTypeImgURL}3.png`,
  },
  {
    number: 4,
    name: `どく`,
    imgURL: `${commonTypeImgURL}4.png`,
  },
  {
    number: 5,
    name: `じめん`,
    imgURL: `${commonTypeImgURL}5.png`,
  },
  {
    number: 6,
    name: `いわ`,
    imgURL: `${commonTypeImgURL}6.png`,
  },
  {
    number: 7,
    name: `むし`,
    imgURL: `${commonTypeImgURL}7.png`,
  },
  {
    number: 8,
    name: `ゴースト`,
    imgURL: `${commonTypeImgURL}8.png`,
  },
  {
    number: 9,
    name: `はがね`,
    imgURL: `${commonTypeImgURL}9.png`,
  },
  {
    number: 10,
    name: `ほのお`,
    imgURL: `${commonTypeImgURL}10.png`,
  },
  {
    number: 11,
    name: `みず`,
    imgURL: `${commonTypeImgURL}11.png`,
  },
  {
    number: 12,
    name: `くさ`,
    imgURL: `${commonTypeImgURL}12.png`,
  },
  {
    number: 13,
    name: `でんき`,
    imgURL: `${commonTypeImgURL}13.png`,
  },
  {
    number: 14,
    name: `エスパー`,
    imgURL: `${commonTypeImgURL}14.png`,
  },
  {
    number: 15,
    name: `こおり`,
    imgURL: `${commonTypeImgURL}15.png`,
  },
  {
    number: 16,
    name: `ドラゴン`,
    imgURL: `${commonTypeImgURL}16.png`,
  },
  {
    number: 17,
    name: `あく`,
    imgURL: `${commonTypeImgURL}17.png`,
  },
  {
    number: 18,
    name: `フェアリー`,
